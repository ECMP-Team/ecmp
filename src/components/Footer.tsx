    ...
    <footer className="bg-dark-space border-t border-gray-800">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-6 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mt-4 text-base text-text-secondary max-w-xs">
              AI-powered email campaign management for modern marketing teams.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="md:order-1 text-base text-text-secondary">
            <p>&copy; {currentYear} CampaignAI. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
